...
export default function FeaturedProductCard({
  ...
  return (
    <div className="lg:col-span-2 bg-white rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row">
      <img
        alt={imageAlt}
      ...
      >
        <p className="text-gray-500 text-sm uppercase font-semibold mb-2">
          {category}
        </p>
        <h2 className="text-3xl font-bold text-[#111418] mb-4 leading-tight">
          {title}
        </h2>
        ...
        <div className="flex items-center mb-6">
          {discount && discount > 0 ? (
            <>
              <p className="text-gray-800  font-bold text-3xl mr-3">
